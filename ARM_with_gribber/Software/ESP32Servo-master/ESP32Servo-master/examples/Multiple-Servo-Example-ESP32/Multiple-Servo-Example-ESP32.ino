...
void setup() {
   ...
   ledcAttachPin(14, 1);   // GPIO 22 assigned to channel 
...
void loop() {
      ...
      ledcWrite(1, 1638);       // sweep servo 1
      delay(200);
       ledcWrite(1, 1030);       // sweep servo 1
      delay(200);
            ledcWrite(1, 1800);       // sweep servo 1
      delay(200);
            ledcWrite(1, 2400);       // sweep servo 1
      delay(200); 
}
